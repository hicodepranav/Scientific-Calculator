...
int main()
{
  ...
  printf("\n");
    switch(op)
  {
    case 1:printf("Which operation you want to perform:");
    printf("\n1. Addition\n2. Subtraction\n3. Multiplication\n4. Division\n");
    scanf("%d",&arith);
    for(i=20;i>=1;i--)
    {
    ...
    break;
    case 2:printf("What do you want to claculate:");
    printf("\n1. Simple Interest\n2. Pofit and loss\n3. Discount\n");
    scanf("%d",&bus);
    for(i=20;i>=1;i--)
    {
    ...
    break;
    case 3:printf("What do you want to do:");
    ...
    break;
    case 4:printf("what do you want to do:");
